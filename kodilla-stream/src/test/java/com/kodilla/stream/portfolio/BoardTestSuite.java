...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        //When
        List<TaskList> avgTimeTasksInProgress = new ArrayList<>();
        avgTimeTasksInProgress.add(new TaskList("In progress"));
        long startedTasks = (long) project.getTaskLists().stream()
                .filter(avgTimeTasksInProgress::contains)
        ...
        //Then
        Assertions.assertEquals(10, startedTasks);
